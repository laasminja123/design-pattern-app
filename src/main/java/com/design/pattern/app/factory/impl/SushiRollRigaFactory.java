...
public class SushiRollRigaFactory extends SushiRollBaseFactory{
    ...
    public SushiRoll createSushiRoll(String type) {
        ...
        {
            case "spicytuna":
                sushiRoll = new SpicyTunaRoll("Spicy Tuna Roll Set", 23.00);
                break;
            case "vegetarian":
                sushiRoll = new VegetarianRoll("Vegetarian Roll Set", 25.00);
                break;
            case "california":
                sushiRoll = new CaliforniaRoll("California Roll Set", 17.00);
                break;
